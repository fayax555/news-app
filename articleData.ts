...
export const articles = [
  {
    ...
    name: 'John Doe',
    authorImg: john,
    date: '12 Jul 2021 10:05 pm',
    title: 'Relic Is Teasing Something on its Twitch Channel',
    body: `There is something going on over on Relic Entertainment's twitch
...
studio's history that definitely aligns with this most closely, but
just to be thorough, let's explore all the possibilities.`,
  },

  {
    ...
    name: 'Ali Ahmed',
    authorImg: ali,
    date: '13 Jan 2021 11:20 am',
    title: 'England lockdown rules to end on 19 July, PM confirms',
    body: `England will move to the final stage of easing Covid restrictions on 19 July, ministers have confirmed. It means almost all legal restrictions on social contact will be removed.
